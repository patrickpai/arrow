...
public class TestFileSystemDataset extends TestNativeDataset {
  ...
  @Test
  public void testParquetReadFilter() throws Exception {
    ParquetWriteSupport writeSupport = ParquetWriteSupport.writeTempFile(AVRO_SCHEMA_USER, TMP.newFolder(), 1, "a", 2, "b", 3, "c");
