...
public class UInt16ScalarExpression extends ScalarExpression {

    private NullableUInt2Holder holder;

    public UInt16ScalarExpression(UInt2Holder holder) {
        NullableUInt2Holder clone = new NullableUInt2Holder();
    ...
    public UInt16ScalarExpression(NullableUInt2Holder holder) {
        NullableUInt2Holder clone = new NullableUInt2Holder();
        clone.isSet = holder.isSet;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addUInt2VectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new UInt16ScalarExpression(holder);
    }
