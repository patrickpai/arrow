...
public class UInt32ScalarExpression extends ScalarExpression {

    private NullableUInt4Holder holder;

    public UInt32ScalarExpression(UInt4Holder holder) {
        NullableUInt4Holder clone = new NullableUInt4Holder();
    ...
    public UInt32ScalarExpression(NullableUInt4Holder holder) {
        NullableUInt4Holder clone = new NullableUInt4Holder();
        clone.isSet = holder.isSet;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addUInt4VectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new UInt32ScalarExpression(holder);
    }
