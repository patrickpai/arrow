...
public class Int64ScalarExpression extends ScalarExpression {

    private NullableBigIntHolder holder;

    public Int64ScalarExpression(BigIntHolder holder) {
        NullableBigIntHolder clone = new NullableBigIntHolder();
    ...
    public Int64ScalarExpression(NullableBigIntHolder holder) {
        NullableBigIntHolder clone = new NullableBigIntHolder();
        clone.isSet = holder.isSet;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addBigIntVectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new Int64ScalarExpression(holder);
    }
