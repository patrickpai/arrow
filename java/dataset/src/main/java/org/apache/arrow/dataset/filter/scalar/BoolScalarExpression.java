...
public class BoolScalarExpression extends ScalarExpression {

    private final NullableBitHolder holder;

    public BoolScalarExpression(BitHolder holder) {
        this(holder.isSet, holder.value);
    }

    public BoolScalarExpression(NullableBitHolder holder) {
        this(holder.isSet, holder.value);
    }

    private BoolScalarExpression(int isSet, int value) {
    ...
    public Expression deepClone() {
        return new BoolScalarExpression(holder);
    }
