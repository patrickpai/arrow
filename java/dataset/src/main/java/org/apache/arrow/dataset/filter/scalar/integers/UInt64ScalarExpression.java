...
public class UInt64ScalarExpression extends ScalarExpression {

    private NullableUInt8Holder holder;

    public UInt64ScalarExpression(UInt8Holder holder) {
        NullableUInt8Holder clone = new NullableUInt8Holder();
    ...
    public UInt64ScalarExpression(NullableUInt8Holder holder) {
        NullableUInt8Holder clone = new NullableUInt8Holder();
        clone.isSet = holder.isSet;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addUInt8VectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new UInt64ScalarExpression(holder);
    }
