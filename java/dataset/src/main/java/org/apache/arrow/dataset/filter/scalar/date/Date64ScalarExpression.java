...
public class Date64ScalarExpression extends ScalarExpression {

    private final NullableDateMilliHolder holder;

    public Date64ScalarExpression(DateMilliHolder holder) {
        NullableDateMilliHolder clone = new NullableDateMilliHolder();
        clone.isSet = 1;
    ...
    public Date64ScalarExpression(NullableDateMilliHolder holder) {
        NullableDateMilliHolder clone = new NullableDateMilliHolder();
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addDateMilliVectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new Date64ScalarExpression(holder);
    }
