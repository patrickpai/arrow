...
public class Int8ScalarExpression extends ScalarExpression {

    private final NullableTinyIntHolder holder;

    public Int8ScalarExpression(TinyIntHolder holder) {
        NullableTinyIntHolder clone = new NullableTinyIntHolder();
        clone.isSet = 1;
    ...
    public Int8ScalarExpression(NullableTinyIntHolder holder) {
        NullableTinyIntHolder clone = new NullableTinyIntHolder();
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addTinyIntVectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new Int8ScalarExpression(holder);
    }
