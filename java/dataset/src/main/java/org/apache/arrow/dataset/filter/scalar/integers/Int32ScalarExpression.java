...
public class Int32ScalarExpression extends ScalarExpression {

    private NullableIntHolder holder;

    public Int32ScalarExpression(IntHolder holder) {
        NullableIntHolder clone = new NullableIntHolder();
    ...
    public Int32ScalarExpression(NullableIntHolder holder) {
        NullableIntHolder clone = new NullableIntHolder();
        clone.isSet = holder.isSet;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addIntVectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new Int32ScalarExpression(holder);
    }
