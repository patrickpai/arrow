...
public class IntervalMonthsScalarExpression extends ScalarExpression {

    private final NullableIntervalYearHolder holder;

    public IntervalMonthsScalarExpression(IntervalYearHolder holder) {
        NullableIntervalYearHolder clone = new NullableIntervalYearHolder();
        clone.isSet = 1;
    ...
    public IntervalMonthsScalarExpression(NullableIntervalYearHolder holder) {
        NullableIntervalYearHolder clone = new NullableIntervalYearHolder();
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addIntervalYearVectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new IntervalMonthsScalarExpression(holder);
    }
