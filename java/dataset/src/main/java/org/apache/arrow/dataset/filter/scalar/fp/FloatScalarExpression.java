...
public class FloatScalarExpression extends ScalarExpression {

    private final NullableFloat4Holder holder;

    public FloatScalarExpression(Float4Holder holder) {
        NullableFloat4Holder clone = new NullableFloat4Holder();
        clone.isSet = 1;
    ...
    public FloatScalarExpression(NullableFloat4Holder holder) {
        NullableFloat4Holder clone = new NullableFloat4Holder();
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addFloat4VectorAsChild(vector, "c1", holder);
    ...
    public Expression deepClone() {
        return new FloatScalarExpression(holder);
    }
