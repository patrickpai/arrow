...
public class OrExpression extends BinaryExpression {
    ...
    private static final byte TYPE = ExpressionType.OR;
    ...
    public StructVector toVector(String vectorName, BufferAllocator allocator) {
        ...
        Util.addIntVectorAsChild(vector, "c3", OrExpression.TYPE);
    ...
    public Expression deepClone() {
        return new OrExpression(super.getLeftOperand(), super.getRightOperand());
    }
}